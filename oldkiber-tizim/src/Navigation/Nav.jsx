        ...
        <div className="nav-cover">
            <div className="upnav">
                ...
                <nav style={{width: strechNavbar.width}} >
                    <Link to={'/actives'}><GiRadioactive size={30} />Faollar</Link>
                    <Link to={'/leads'}><BsBoxArrowInDown size={35} /> Leadlar</Link>
                    <Link to={'/teachers'}><MdOutlinePerson2 size={40} />O'qituvchilar</Link>
                    <Link to={'/groups'}> <LiaLayerGroupSolid size={40} />Guruhlar</Link>
                    <Link to={'/students'}><BsFillPersonFill size={40}/>Talabalar</Link>
                    <Link to={'/finance'}><RiRefund2Fill size={40}/>Moliya</Link>
                    <Link to={'/reports'}><LiaChartPieSolid size={40} />Xisobot</Link>
                    <Link to={'/#settings'}><LuSettings size={40} fontWeight={100} />Sozlamalar</Link>
